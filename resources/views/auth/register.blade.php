                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="paterno" type="text" class="form-control @error('paterno') is-invalid @enderror" name="paterno" value="{{ old('paterno') }}" required autocomplete="name" autofocus>
                            ...
                            <div class="col-md-6">
                                <div class="card text-center">
                                    ...
                                    @if(isset($producto->foto))
                                        <br/>
                                        <img src="{{asset('storage').'/'.$producto->foto}}" class="img-thumbnail img-fluid" alt="" width="200">
                                        <br/>
                                    @endif
                                    <input type="file" placeholder="Subir" class="btn btn-primary" name="foto" id="foto" value="{{ isset($producto->foto)?$producto->foto:old('foto')}}">
                                </div>
                            </div>
                        </div>
