	...
	<div class="card">
		<div class="card-header justify-content-between">
            <div class="d-flex justify-content-between">
                <h6>{{ __('Restaurar contraseñas a usuarios') }}</h6>
            </div>
        </div>
        <div class="card-body">
        	<div class="table-responsive">
				<table class="table center text-center table-sm" id="tabla_restUser">
				  ...
				  <tbody>
				    ...
				    <tr id="{{$cate->id}}">
				      ...
				      <td>
				      	<button type="button" class="btn btn-success btn-sm EditarCat" data-toggle="modal" data-target="#ModalCategoria" id="{{$cate->id}}"><i class="far fa-edit"></i></button>
